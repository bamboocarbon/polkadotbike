...
const RACES = [
  ...
  { file: 'tdf.html',   name: 'Tour de France 2026', slug: 'tdf',  h2col: '#ffe94d' },
  { file: 'giro26.html', name: "Giro d'Italia 2026", slug: 'giro', h2col: '#ec4899' },
];
...
const TYPE_LABEL = { Mountain: 'Mountain stage', Hilly: 'Hilly stage', Sprint: 'Sprint stage', TTT: 'Team time trial', ITT: 'Individual time trial' };
const CAT_CLS = { HC: 'cat-hc', Cat1: 'cat-cat1', Cat2: 'cat-cat2', Cat3: 'cat-cat3', Cat4: 'cat-cat4', TBC: 'cat-tbc' };
